...
for ep in range (15):#episode
    # prep inp [en3_32,ATL32,aud6,num1] total 71
    rand_0 = 2#np.random.randint(3)  # rand_0>0.5 move;  <0.5 thisis
    ...
    file_nm = '/Users/fengqi/Pycharm_py36/QF/ThisMovieSize' + str(chk_num) + str(rand_1) + '.jpeg'
    fig = plt.gcf()
