...
for ep in range (tot_episodes):#episode
    ...
    rand_0 = np.random.random(1) #rand_0>0.5 move;  <0.5 thisis
    ...
    for ii in range(BATCH_SIZE):
        ...
        if rand_0>0.5:
            ...
            b_x_2[ii]=b_x_1[ii]
        en3_1[ii], ff1_1[ii] = sess.run([en3, ff1],{tf_x: np.reshape(b_x_1[ii],[1,784]), ph_encoded: ph_encoded_1, ph_switch: ph_switch_1, ph_dis_e: ph_dis_e_1})
        en3_2[ii], ff1_2[ii] = sess.run([en3, ff1],{tf_x: np.reshape(b_x_2[ii],[1,784]), ph_encoded: ph_encoded_1, ph_switch: ph_switch_1, ph_dis_e: ph_dis_e_1})
    ...
    if ((ep+1) % 1000 == 0):
        ...
        try:
            ...
            path = '/Users/fengqi/Pycharm_py36/QF/ThisMove' + str(ep+1) + '/'
            file_='CKPT001'
            os.mkdir(path)
