...
for ep in range (tot_episodes):#episode
    ...
    _,cost_his[ep]=sess.run([dlPFC_train,dlPFC_loss],{dlPFC_x:whole_[:,0:29,:],dlPFC_y:whole_[:,1:30,0:38]})
    ...
    if ((ep+1) % 1000 == 0):
        ...
        try:
            ...
            path = '/Users/fengqi/Pycharm_py36/QF/dlPFC' + str(ep+1) +'_Lambda'+str(lambda1)+ '/'
            file_='CKPT001'
            os.mkdir(path)
