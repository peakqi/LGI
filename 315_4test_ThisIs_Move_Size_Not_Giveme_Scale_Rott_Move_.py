...
path = '/Users/fengqi/Pycharm_py36/QF/ThisMoveSizeNotGiveScaleRottMove_whole' + str(chk_num) + '/'
file_='CKPT001'
...
for ep in range (20):#episode
    ...
    file_nm = '/Users/fengqi/Pycharm_py36/QF/ThisMovieSizeNotGiveScaleRottMove_whole' + str(chk_num) + str(rand_1) + '.jpeg'
    fig = plt.gcf()
