...
path = '/Users/fengqi/Pycharm_py36/QF/dlPFC' + str(chk_num) + '_30/'
file_='CKPT001'
...
for ep in range (20):#episode
    ...
    file_nm = '/Users/fengqi/Pycharm_py36/QF/Move' + str(chk_num) + str(rand_1) + '.jpeg'
    fig = plt.gcf()
    ...
    file_nm = '/Users/fengqi/Pycharm_py36/QF/Move' + str(chk_num) + str(rand_1) + '_short.jpeg'
    fig = plt.gcf()
    fig.set_size_inches(18.5, 10.5)
    fig.savefig(file_nm, dpi=100)
    plt.close('all')
